...
public class BasePopupWindow  extends PopupWindow {
    ...
    private PopupDismissmaListener mOnDismissListener;
    ...
    public void setmOnDismissListener(PopupDismissmaListener mOnDismissListener) {
