 ...
 * Remark：
 */
public class StaffWorkStatistics_CL_ListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    List<StaffWorkStatistics_CL_Model> data = new ArrayList<>();
    ...
    static class Item2ViewHolder extends RecyclerView.ViewHolder {
        LinearLayout LL_BKG;
        TextView TV_FBillNO;
        TextView TV_FBillDate;
        TextView TV_FOrganizeName;
        TextView TV_FDeptName;
        TextView TV_FScmoNO;
        TextView TV_FProcessFlowName;
        TextView TV_FItemNo;
        ...
        public Item2ViewHolder(View itemView) {
            ...
            this.LL_BKG = (LinearLayout) itemView.findViewById(R.id.LL_BKG);
            this.TV_FBillNO = (TextView) itemView.findViewById(R.id.TV_FBillNO);
            this.TV_FBillDate = (TextView) itemView.findViewById(R.id.TV_FBillDate);
            this.TV_FOrganizeName = (TextView) itemView.findViewById(R.id.TV_FOrganizeName);
            this.TV_FDeptName = (TextView) itemView.findViewById(R.id.TV_FDeptName);
            this.TV_FScmoNO = (TextView) itemView.findViewById(R.id.TV_FScmoNO);
            this.TV_FProcessFlowName = (TextView) itemView.findViewById(R.id.TV_FProcessFlowName);
    ...
    public StaffWorkStatistics_CL_ListAdapter(List<StaffWorkStatistics_CL_Model> data, boolean isshowprice, boolean isshowamount) {
        super();
        this.data = data;
        isShowPrice = isshowprice;
        isShowAmount = isshowamount;
        List<StaffWorkStatistics_CL_Model> list = new ArrayList<>();
        for (StaffWorkStatistics_CL_Model datum : data) {
    ...
    public void Updata(List<StaffWorkStatistics_CL_Model> data) {
        this.data = data;
        List<StaffWorkStatistics_CL_Model> list = new ArrayList<>();
        for (StaffWorkStatistics_CL_Model datum : data) {
            if (datum.getFlevel() == 2) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == ITEM_TYPE.ITEM1.ordinal()) {
            ...
            return new Item2ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_staff_work_statistics_cl, null));
        }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        StaffWorkStatistics_CL_Model sws = data.get(position);
    ...
    private void setItem1(final RecyclerView.ViewHolder holder, StaffWorkStatistics_CL_Model sws) {
        ...
        ((Item1ViewHolder) holder).TV_FBillNO.setText(sws.getFBillNO());
    }

    private void setItem2(final RecyclerView.ViewHolder holder, StaffWorkStatistics_CL_Model sws) {
        ...
        if (sws.getFlevel() == 3) {
            ...
            ((Item2ViewHolder) holder).TV_FBillNO.setText(sws.getFBillNO());
            ((Item2ViewHolder) holder).TV_FBillDate.setText(sws.getFBillDate());
            ((Item2ViewHolder) holder).TV_FOrganizeName.setText(sws.getFOrganizeName());
            ((Item2ViewHolder) holder).TV_FDeptName.setText(sws.getFDeptName());
            ((Item2ViewHolder) holder).TV_FScmoNO.setText(sws.getFScmoNO());
            ((Item2ViewHolder) holder).TV_FProcessFlowName.setText(sws.getFProcessFlowName());
            ...
            ((Item2ViewHolder) holder).TV_FBillNO.setText(sws.getFBillNO());
            ((Item2ViewHolder) holder).TV_FBillDate.setText("");
            ((Item2ViewHolder) holder).TV_FOrganizeName.setText("");
            ((Item2ViewHolder) holder).TV_FDeptName.setText("");
            ((Item2ViewHolder) holder).TV_FScmoNO.setText("");
            ((Item2ViewHolder) holder).TV_FProcessFlowName.setText("");
            ((Item2ViewHolder) holder).TV_FItemNo.setText("");
