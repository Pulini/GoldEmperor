...
public class define {
    ...
    public static String IP1718341="http://geapp.goldemperor.com:8341/";

    public static String IP1718020="http://geapp.goldemperor.com:8020/";

    public static String IP1718012="http://geapp.goldemperor.com:8012/";//外网

    public static String IP1718056="http://geapp.goldemperor.com:8056/";

    public static String IP1718083="http://geapp.goldemperor.com:8083/";
...
//    public static final String ReCheckAbnormity = "wechatMvn/android/ReCheckAbnormity.do";
    ...
    public static final String SubmitBarCodeBarCode2Ck_RequisitionSlipCollectBillByEmpCode = "SubmitBarCodeBarCode2Ck_RequisitionSlipCollectBillByEmpCode";
    public static final String GetSubmitBarCodeReport = "GetSubmitBarCodeReport";
    ...
    public static final String GetReport = "ErpForAndroidStockServer.asmx/GetSubmitBarCodeReport";
    ...
    public static final String SharedScanList = "SharedScanList";
    ...
    public static final String PRA_BarCode = "PRA_BarCode";
    public static final String SCR_BarCode = "SCR_BarCode";
    ...
    public static String WEB_GETSUBMITBARCODEREPORT = "GetSubmitBarCodeReport";
