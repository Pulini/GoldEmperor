...
import com.goldemperor.DayWorkCardReport.activity.WorkshopDailyReportActivity;
 ...
 * Remark：主页1
 */
@ContentView(R.layout.fragment_home2_for_tv)
public class HomeForTVFragment2 extends ViewPagerFragment implements HomeAdapter.HomeItemClickListener, NewLoginListener, HomeUtils.JurisdictionListener {
...
//        BD.add(new ButtonData("工序汇报入库", "1050701", R.drawable.btn_process, new Intent(mActivity, ProcessReportInstockActivity.class)));
        ...
        BD.add(new ButtonData("<com.panzx.pulini.Bootstrap.BootstrapDropDown", "", R.drawable.btn_order, new Intent(mActivity, CCListActivity.class)));
    ...
    private void showdialog() {
        ...
        menuItems.add(new SuperDialog.DialogMenuItem("车间生产日报表"));
                ...
                .setListener((isButtonClick, position) -> {
                    switch (position) {
                        ...
                        case 1:
                            ...
                            break;
                        case 2:
                            mActivity.startActivity(new Intent(mActivity, WorkshopDailyReportActivity.class));
                            break;
                    }
                }).show();
