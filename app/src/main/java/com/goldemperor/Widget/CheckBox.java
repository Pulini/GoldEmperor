...
public class CheckBox extends View implements Checkable {
    ...
    private int hSize = dp2px(25);
    private int wSize = dp2px(25);
    private int textSize = dp2px(25);
    ...
    public CheckBox(Context context, AttributeSet attrs) {
        ...
        if(attrs != null){
            ...
            textColor = array.getColor(R.styleable.BBox_color_text, Color.BLACK);

            hSize = (int)array.getDimension(R.styleable.BBox_check_size,20);
            wSize = (int)array.getDimension(R.styleable.BBox_check_size,20);
            textSize = (int)array.getDimension(R.styleable.BBox_check_size,20);
...
//        mPaintText.setStrokeWidth(strokeWidth);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(isHook) {
            ...
            canvas.drawText(boxText, wStart  + wSize + 18, (hSize + textSize )/2-textSize/6, mPaintText);
            //确保图形在正中
