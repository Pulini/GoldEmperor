...
public class SuperDialog extends Dialog {
    ...
    private ViewGroup.LayoutParams contentTextLayoutParams;
...
//                layoutParams.setMargins(10, 10, 10, 10);
    ...
    public SuperDialog setContentTextGravity(int gravity) {
        this.contentTextGravity = gravity;
        return this;
    }
    public SuperDialog setContentTextLayoutParams(ViewGroup.LayoutParams lp) {
        this.contentTextLayoutParams = lp;
        return this;
    }
    ...
    class ListDialogAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            menuItemView.setGravity(contentTextGravity);
            return menuItemView;
        }
    }
    ...
    public static class DialogMenuItem {
        ...
        public DialogMenuItem(String itemName) {
            this.itemName = itemName;
        }
    }
}
