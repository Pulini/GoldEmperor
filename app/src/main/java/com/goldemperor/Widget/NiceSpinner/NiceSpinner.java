package com.goldemperor.Widget.NiceSpinner;
...
//                }
        ...
        arrowDrawableResId = typedArray.getResourceId(R.styleable.NiceSpinner_arrowDrawable, R.drawable.arrows);
        dropDownListPaddingBottom =
                typedArray.getDimensionPixelSize(R.styleable.NiceSpinner_dropDownListPaddingBottom, 0);
        typedArray.recycle();
        arrowDrawable = ContextCompat.getDrawable(getContext(), arrowDrawableResId);
    ...
    public void setArrowDrawable(@DrawableRes @ColorRes int drawableId) {
        ...
        arrowDrawable = initArrowDrawable(R.drawable.arrows);
        setArrowDrawableOrHide(arrowDrawable);
    }
    ...
    public void setTextInternal(String text) {
        if (selectedTextFormatter != null) {
            ...
            setBackgroundResource(R.drawable.shape_spinner_bkg);
        } else {
            setText(text);
        }
    }
...
//        int Height= listView.getMeasuredHeight() - dropDownListPaddingBottom;
        int Height = 0;
        try {
