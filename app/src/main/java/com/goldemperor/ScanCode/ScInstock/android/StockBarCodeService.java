...
public class StockBarCodeService extends Thread {
    ...
    public void run() {
        ...
        try {
            ...
            String XMLContent = PublicService.GetWebServiceComnon(myContext,  define.Net2+"ErpForAndroidStockServer.asmx", "GetDataTableAccountSuit", "suitID", _DefaultSuitID);
            Log.i(TAG, "XMLContent:" + XMLContent);//获得移动设备IMEI码
            LOG.e("XMLContent="+XMLContent);
            ...
            LOG.e("3套账信息="+myMessageObject.toString());
            myHandler.sendMessage(message);


            //设定组织信息下拉框
            String XMLContent2 = PublicService.GetWebServiceComnon(myContext, define.Net2+"ErpForAndroidStockServer.asmx", "GetOrganization", "suitID", _DefaultSuitID);
            ...
            LOG.e("3组织信息="+myMessageObject2.toString());
