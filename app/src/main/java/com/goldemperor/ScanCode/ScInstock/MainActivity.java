...
import com.goldemperor.ScanCode.ScInstock.android.CommDB;
import com.goldemperor.ScanCode.ScInstock.android.Config;
import com.goldemperor.ScanCode.ScInstock.android.NetworkHelper;
import com.goldemperor.ScanCode.ScInstock.android.NewBarCodeDB;
import com.goldemperor.ScanCode.ScInstock.android.PublicService;
import com.goldemperor.ScanCode.ScInstock.android.StockBarCodeService;
import com.goldemperor.ScanCode.ScInstock.android.SubmitBarCodeService;
import com.goldemperor.ScanCode.ScInstock.android.TelephonyManagerClass;
import com.goldemperor.ScanCode.ScInstock.deleteslide.ActionSheet;
import com.goldemperor.ScanCode.ScInstock.model.BarCode;
import com.goldemperor.ScanCode.ScInstock.model.DeviceInfoMap;
import com.goldemperor.ScanCode.ScInstock.model.MessageEnum;
import com.goldemperor.ScanCode.ScInstock.model.MessageObject;
import com.goldemperor.ScanCode.ScInstock.model.UpdataInfo;
...
//        setRiverListViewAdapter();
        stockin.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked&&userLoginInfo!=null) {
                    userLoginInfo.userInfo.setBillTypeID("106");
                }
            }
        });
        stockout.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked&&userLoginInfo!=null) {
                    userLoginInfo.userInfo.setBillTypeID("107");
                }
            }
        });
        GetBarCodeStatus();
    ...
    private void GetBarCodeStatus() {
        ...
        if (stockin.isChecked()) {
            ...
            params.addQueryStringParameter("SearchFieldName", "FOutStockBillID");
        } else {
            Toast.makeText(mContext, "请选择入库或者领料", Toast.LENGTH_LONG).show();
            return;
        }
...
//                    redrawscan_table();
                ...
                case MessageEnum.SubmitClearData://成功提交数据，生产单据后，删除本地所有数据
                    ...
                    String StockBillNO = "";
                    LOG.e("登陆成功" + myMessageObject2.Content);
                ...
                case MessageEnum.ClearSubmitData://先提交数据到webservice,再删除本地所有数据
                    ...
                    LOG.e("UserID=" + UserID);
                    Athread = new SubmitBarCodeService(this, myContext, userLoginInfo, AllDataJson, dd);
                    HttpUtils.CheckPermissions(act, "1050201", UserID, new HttpUtils.OnCheckPermissionsListener() {
                        @Override
