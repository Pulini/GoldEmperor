...
import com.goldemperor.ScanCode.SupperInstock.android.LoginService;
...
import com.goldemperor.ScanCode.SupperInstock.android.UserInfoDB;
import com.goldemperor.ScanCode.SupperInstock.android.UserLoginHelper;
import com.goldemperor.ScanCode.SupperInstock.android.XmlUtils;
import com.goldemperor.ScanCode.SupperInstock.model.AccountSuit;
...
import com.goldemperor.ScanCode.SupperInstock.model.Organization;
        ...
        */
        public void DoLogin(Message msg)
        {
            ...
            if(result.equals("success") ) {
                ...
                setResult(11);
                finish();
//                MainActivity.mainActivity_instance.ClearSubmitData(myContext,"LoginActivty");
            }
            else
            {
