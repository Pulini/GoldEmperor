...
import com.goldemperor.ScanCode.ScReport.ScReportActivity;
...
public class StockBarCodeService extends Thread {
    ...
    public void run() {
        ...
        try {
            ...
            LOG.e("1套账信息="+myMessageObject.toString());
            ...
            LOG.e("1组织信息="+myMessageObject2.toString());
            ...
            //创建登录配置信息对象
            if(ScReportActivity.myConfig==null)
                ScReportActivity.myConfig=new Config();
