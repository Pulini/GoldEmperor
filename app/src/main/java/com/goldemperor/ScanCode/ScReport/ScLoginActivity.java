...
import com.goldemperor.ScanCode.ScReport.android.LoginService;
import com.goldemperor.ScanCode.ScReport.android.PublicService;
import com.goldemperor.ScanCode.ScReport.android.UserInfoDB;
import com.goldemperor.ScanCode.ScReport.android.UserLoginHelper;
...
public class ScLoginActivity extends Activity {
    ...
    public ScReportActivity.BarCodeHandler barCodeHandler;
...
//        NewScReportActivity.loginActivity_instance=ScLoginActivity.this;//以便在别的activity中可以直接调用
    }
    ...
    private void attemptLogin() {
        ...
        if(NowSelectAccountSuit.FAccountSuitID==null||NowSelectOrganization.FItemID==null||NowSelectBillType==null){
            return;
        }
        ...
        ScReportActivity.userLoginInfo=userLoginInfo;
