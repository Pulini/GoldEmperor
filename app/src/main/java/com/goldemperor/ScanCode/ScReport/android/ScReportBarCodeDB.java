 ...
 * 条形码表操作类
 */
public class  ScReportBarCodeDB{
...
//    private LinkedList<String> myList;
    ...
    public ScReportBarCodeDB(Context ctx, Handler handler, CodeAdapter mAdapter, TextView txtcount, List<String> bcsml) {
...
//        bcsml.add("18095430060838/101");
    ...
    public ScReportBarCodeDB open() throws SQLException {
    ...
    public boolean ClearSubmitData(Context myContext,String MessageType) {
        ...
        if( myAdapter.mlist.size()>0) {
            if (MessageType!="CxLoginActivty") {
                ...
                myMessageObject.Content = "ScReportActivity";
