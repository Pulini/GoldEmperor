package com.goldemperor.ScanCode.CxStockIn.DialogLoadding;
...
public class DialogThridUtils {
    ...
    public static Dialog showWaitDialog(Context context, String msg, boolean isTransBg, boolean isCancelable) {
        ...
        View v = inflater.inflate(R.layout.cxstockin_thridlogin_dialog_loading, null);             // 得到加载view
        ...
        // 加载动画
        Animation hyperspaceJumpAnimation = AnimationUtils.loadAnimation(context, R.anim.cxstockin_rotate_animation);
        // 使用ImageView显示动画
