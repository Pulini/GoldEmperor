...
import com.goldemperor.ScanCode.CxStockIn.android.LoginService;
...
import com.goldemperor.ScanCode.CxStockIn.android.UserInfoDB;
import com.goldemperor.ScanCode.CxStockIn.android.UserLoginHelper;
import com.goldemperor.ScanCode.CxStockIn.android.XmlUtils;
...
import com.goldemperor.model.Organization;
...
public class CxLoginActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button mbutton_sign_in = (Button) findViewById(R.id.button_sign_in);
        mbutton_sign_in.setOnClickListener(new OnClickListener() {
            @Override
        ...
        Button mbutton_sign_return = (Button) findViewById(R.id.button_sign_return);
        mbutton_sign_return.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                attemptReturn();
            }
        ...
        CxStockInActivity.loginActivity_instance=CxLoginActivity.this;//以便在别的activity中可以直接调用
    }
        ...
        */
        public void DoLogin(Message msg)
        {
            ...
            if(result.equals("success") ) {
                ...
                UserInfoDBHelper.InsertUserInfo(userLoginInfo.userInfo);
                CxStockInActivity.mainActivity_instance.ClearSubmitData(myContext,"CxLoginActivty");
            }
            else
            {
