...
import com.goldemperor.PropertyRegistration.Phone.PropertyRegistrationDetailsForPhoneActivity;
 ...
 * Remark：财产列表
 */
@ContentView(R.layout.activity_property_registration_list_for_pad)
public class PropertyRegistrationListForPadActivity extends Activity {
    ...
    private PropertyRegistrationListForPadAdapter PRLA;
    ...
    private void initview() {
        ...
        PRLA = new PropertyRegistrationListForPadAdapter(PML);
        ...
        PRLA.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void ItemClick(int Position) {
                startActivity(new Intent(mActivity, PropertyRegistrationDetailsForPadActivity.class).putExtra("InterID", PML.get(Position).getFInterID()));
            }
