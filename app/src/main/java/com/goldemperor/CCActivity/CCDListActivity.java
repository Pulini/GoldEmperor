...
public class CCDListActivity extends AppCompatActivity {

    private SwipeMenuRecyclerView mMenuRecyclerView;
    private Context mContext;
    private Activity act;
    private TextView tv_tip;
    public CCDListAdapter mMenuAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMenuAdapter = new CCDListAdapter(facardResultList);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.ccdbar, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.menu_action_1) {
            ...
            Intent i = new Intent(mContext, NewCCDActivity.class);
            startActivityForResult(i, 0);
        }
