 ...
 */
public class CCDListAdapter extends RecyclerView.Adapter<CCDListAdapter.DefaultViewHolder> {
    ...
    public CCDListAdapter(List<facardResult> ls) {
        this.ls = ls;
    ...
    @Override
    public void onBindViewHolder(CCDListAdapter.DefaultViewHolder holder, int position) {
